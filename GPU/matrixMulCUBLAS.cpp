...
void initializeCUDA(int argc, char **argv, int &devID, int &iSizeMultiple, sMatrixSize &matrix_size)
{
    ...
    if (checkCmdLineFlag(argc, (const char **)argv, "H1"))
    {
        matrix_size.uiHA = getCmdLineArgumentInt(argc, (const char **)argv, "H1=");
    }

    if (checkCmdLineFlag(argc, (const char **)argv, "W1"))
    {
        matrix_size.uiWA = getCmdLineArgumentInt(argc, (const char **)argv, "W1=");
    }

    if (checkCmdLineFlag(argc, (const char **)argv, "W2"))
    {
        matrix_size.uiWB = getCmdLineArgumentInt(argc, (const char **)argv, "W2=");
    }
    //matrix_size.uiHA = std::stoi(argv[0]);
    //matrix_size.uiWA = std::stoi(argv[1]);
    //matrix_size.uiWB = std::stoi(argv[2]);
    matrix_size.uiHB = matrix_size.uiWA;
